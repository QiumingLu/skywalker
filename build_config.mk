SOURCES=machine/state_machine.cc machine/state_machine_factory.cc machine/state_machine_impl.cc network/messager.cc network/network.cc paxos/acceptor.cc paxos/checkpoint_manager.cc paxos/config.cc paxos/counter.cc paxos/group.cc paxos/instance.cc paxos/learner.cc paxos/node_impl.cc paxos/nodeinfo.cc paxos/paxos.pb.cc paxos/proposer.cc paxos/runloop.cc paxos/transfer.cc storage/db.cc util/logging.cc util/mutex.cc util/thread.cc 
CC=cc
CXX=g++
PLATFORM=OS_LINUX
