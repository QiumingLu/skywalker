...
class MasterState;
class MasterStateDefaultTypeInternal;
extern MasterStateDefaultTypeInternal _MasterState_default_instance_;
class Membership;
...
class Membership : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:skywalker.Membership) */ {
 public:
  ...
  inline Membership* New() const PROTOBUF_FINAL { return New(NULL); }

  Membership* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class MasterState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:skywalker.MasterState) */ {
 public:
  ...
  static inline const MasterState* internal_default_instance() {
    return reinterpret_cast<const MasterState*>(
               &_MasterState_default_instance_);
  }
  ...
  inline MasterState* New() const PROTOBUF_FINAL { return New(NULL); }

  MasterState* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
